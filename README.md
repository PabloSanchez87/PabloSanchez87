<h1 align="center">🤝 Transformando ideas en código · Turning ideas into code</h1>

![banner](resources/bannerfoto_recorte.png)

<p align="center">
  <b>Pablo Sánchez Torres</b><br/>
  <i>AI / ML Engineer · Agentic AI · Applied ML</i>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Agentic_AI-1C3C3C?style=flat-square&logo=langchain&logoColor=white" alt="Agentic AI"/>
  <img src="https://img.shields.io/badge/RAG-412991?style=flat-square&logo=openai&logoColor=white" alt="RAG"/>
  <img src="https://img.shields.io/badge/Affective_Computing-8E75B2?style=flat-square&logo=googlegemini&logoColor=white" alt="Affective Computing"/>
  <img src="https://img.shields.io/badge/MLOps-FF6F00?style=flat-square&logo=lightning&logoColor=white" alt="MLOps"/>
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/pablosancheztorres"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
  <a href="mailto:sancheztorrespablo@gmail.com"><img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/></a>
  <a href="https://github.com/PabloSanchez87"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/></a>
</p>
...
|----------|-------------|-------------|
| [**Databricks Medallion Pipeline**](https://github.com/PabloSanchez87/databricks-medallion-pipeline) | Pipeline de ingeniería de datos end-to-end con arquitectura Medallion (Bronze/Silver/Gold), DLT con CDC y modelos analíticos. | `Databricks` `dbt` `PySpark` `SQL` |
| [**Transformer from Scratch**](https://github.com/PabloSanchez87/Transformer-paper) | Implementación componente a componente de la arquitectura Transformer siguiendo *“Attention is All You Need”*. | `Python` `Deep Learning` |
| [**Word Embeddings for NLP**](https://github.com/PabloSanchez87/Word-Embeddings-for-NLP) | Exploración manual de embeddings (GloVe): similitud coseno, aritmética vectorial y visualización PCA/t-SNE. | `Python` `NLP` |
| [**Neural Network desde cero**](https://github.com/PabloSanchez87/NeuralNetwork-Fundamentals-MNIST) | Red neuronal implementada desde cero sobre MNIST, sin frameworks de alto nivel. | `Python` `NumPy` |
| [**Cervantes GRU-RNN**](https://github.com/PabloSanchez87/Cervantes-GRU-RNN) | Generación de texto con arquitectura encoder-decoder basada en RNN/GRU. | `TensorFlow` `Keras` |
| [**Utils with Python**](https://github.com/PabloSanchez87/Utils_with_Python) | Colección de utilidades, incluido un generador interactivo de facturas en PDF. | `Python` `Streamlit` |
...
|---------|-------------|------|
| [**Databricks Medallion Pipeline**](https://github.com/PabloSanchez87/databricks-medallion-pipeline) | End-to-end data engineering pipeline with Medallion architecture (Bronze/Silver/Gold), DLT with CDC and analytical models. | `Databricks` `dbt` `PySpark` `SQL` |
| [**Transformer from Scratch**](https://github.com/PabloSanchez87/Transformer-paper) | Component-by-component implementation of the Transformer architecture, following *“Attention is All You Need”*. | `Python` `Deep Learning` |
| [**Word Embeddings for NLP**](https://github.com/PabloSanchez87/Word-Embeddings-for-NLP) | Hands-on exploration of embeddings (GloVe): cosine similarity, vector arithmetic and PCA/t-SNE visualization. | `Python` `NLP` |
| [**Neural Network from Scratch**](https://github.com/PabloSanchez87/NeuralNetwork-Fundamentals-MNIST) | Neural network built from scratch on MNIST, with no high-level frameworks. | `Python` `NumPy` |
| [**Cervantes GRU-RNN**](https://github.com/PabloSanchez87/Cervantes-GRU-RNN) | Text generation with an RNN/GRU-based encoder-decoder architecture. | `TensorFlow` `Keras` |
| [**Utils with Python**](https://github.com/PabloSanchez87/Utils_with_Python) | A collection of utilities, including an interactive PDF invoice generator. | `Python` `Streamlit` |
